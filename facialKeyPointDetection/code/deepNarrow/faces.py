...
filter1 = tf.Variable(tf.truncated_normal([5,5,1,8], stddev=0.1), name="filter1")
biases1 = tf.Variable(tf.truncated_normal([8], stddev=0.1), name="biases1")
conv1 = tf.nn.relu(tf.nn.conv2d(xInp, filter1, [1,1,1,1], padding="VALID") + biases1)

filter1_ = tf.Variable(tf.truncated_normal([5,5,8,16], stddev=0.1), name="filter1_")
biases1_ = tf.Variable(tf.truncated_normal([16], stddev=0.1), name="biases1_")
...
filter2 = tf.Variable(tf.truncated_normal([5,5,16,32], stddev=0.1), name="filter2")
biases2 = tf.Variable(tf.truncated_normal([32], stddev=0.1), name="biases2")
conv2 = tf.nn.relu(tf.nn.conv2d(pool1, filter2, [1,1,1,1], "VALID") + biases2)

filter2_ = tf.Variable(tf.truncated_normal([3,3,32,32], stddev=0.1), name="filter2_")
biases2_ = tf.Variable(tf.truncated_normal([32], stddev=0.1), name="biases2_")
...
filter3 = tf.Variable(tf.truncated_normal([4,4,32, 64], stddev=0.1), name="filter3")
biases3 = tf.Variable(tf.truncated_normal([64], stddev=0.1), name="biases3")
conv3 = tf.nn.relu(tf.nn.conv2d(pool2, filter3, [1,1,1,1], "VALID") + biases3)

filter3_ = tf.Variable(tf.truncated_normal([3,3,64, 64], stddev=0.1), name="filter3_")
biases3_ = tf.Variable(tf.truncated_normal([64], stddev=0.1), name="biases3_")
...
filter4 = tf.Variable(tf.truncated_normal([3,3,64, 128], stddev=0.1), name="filter4")
biases4 = tf.Variable(tf.truncated_normal([128], stddev=0.1), name="biases4")
conv4 = tf.nn.relu(tf.nn.conv2d(pool3, filter4, [1,1,1,1], "VALID") + biases4)

filter4_ = tf.Variable(tf.truncated_normal([3,3,128, 256], stddev=0.1), name="filter4_")
biases4_ = tf.Variable(tf.truncated_normal([256], stddev=0.1), name="biases4_")
conv4_ = tf.nn.relu(tf.nn.conv2d(conv4, filter4_, [1,1,1,1], "VALID") + biases4_)


filter5 = tf.Variable(tf.truncated_normal([3, 3, 256, 512], stddev=0.1), name="filter5")
biases5 = tf.Variable(tf.truncated_normal([512], stddev=0.1), name="biases5")
...
# fcw0 = tf.Variable(tf.truncated_normal([1024, 512], stddev=0.1), name="fullyConnectedWeights1")
...
fcw1 = tf.Variable(tf.truncated_normal([512, 256], stddev=0.1), name="fullyConnectedWeights1")
fcb1 = tf.Variable(tf.truncated_normal([256], stddev=0.1), name="fullyConnectedBiases1")
fc1 = tf.nn.dropout(tf.matmul(outFromConv, fcw1) + fcb1, keepRate)

fcw2 = tf.Variable(tf.truncated_normal([256, 128], stddev=0.1), name="fullyConnectedWeights2")
fcb2 = tf.Variable(tf.truncated_normal([128], stddev=0.1), name="fullyConnectedBiases2")
fc2 = tf.nn.dropout(tf.matmul(fc1, fcw2) + fcb2, keepRate)

fcw3 = tf.Variable(tf.truncated_normal([128, 128], stddev=0.1), name="fullyConnectedWeights3")
fcb3 = tf.Variable(tf.truncated_normal([128], stddev=0.1), name="fullyConnectedBiases3")
fc3 = tf.nn.dropout(tf.matmul(fc2, fcw3) + fcb3, keepRate)

fcw3_ = tf.Variable(tf.truncated_normal([128, 64], stddev=0.1), name="fullyConnectedWeights3")
fcb3_ = tf.Variable(tf.truncated_normal([64], stddev=0.1), name="fullyConnectedBiases3")
fc3_ = tf.nn.dropout(tf.matmul(fc3, fcw3_) + fcb3_, keepRate)

fcw4 = tf.Variable(tf.truncated_normal([64, 64], stddev=0.1), name="fullyConnectedWeights4")
fcb4 = tf.Variable(tf.truncated_normal([64], stddev=0.1), name="fullyConnectedBiases4")
fc4 = tf.nn.dropout(tf.matmul(fc3_, fcw4) + fcb4, keepRate)

fcw5 = tf.Variable(tf.truncated_normal([64, 64], stddev=0.1), name="fullyConnectedWeights5")
fcb5 = tf.Variable(tf.truncated_normal([64], stddev=0.1), name="fullyConnectedBiases5")
fc5 = tf.nn.dropout(tf.matmul(fc4, fcw5) + fcb5, keepRate)

fcw6 = tf.Variable(tf.truncated_normal([64,30], stddev=0.1), name="fullyConnectedWeights6")
fcb6 = tf.Variable(tf.truncated_normal([30], stddev=0.1), name="fullyConnectedBiases6")
fc6 = tf.matmul(fc5, fcw6) + fcb6

# foo = tf.shape(tf.reshape(fc6, [-1]))
# foo1 = tf.shape(tf.reshape(cor, [-1]))

loss = tf.reduce_mean(tf.sqrt(tf.abs(tf.subtract(tf.boolean_mask(tf.reshape(fc6, [-1]), tf.reshape(mask, [-1])), tf.reshape(cor, [-1])))))
